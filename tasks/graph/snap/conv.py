...
class GNNNode(torch.nn.Module):
    ...
    def forward(self, batched_data):
        x, edge_index, edge_attr, _ = batched_data.x, batched_data.edge_index, batched_data.edge_attr, batched_data.batch
        ...
        ### Different implementations of jumping_knowledge-concat
        if self.jumping_knowledge == "last":
            node_representation = h_list[-1]
        elif self.jumping_knowledge == "sum":
